export default {
    "serverSetup": {
        "title": "Einmaliger Schritt auf dem Server nötig",
        "text": "Diese Version braucht eine einmalige Änderung auf dem Server, die der Aktualisieren-Button nicht selbst vornehmen kann: Er läuft als Web-Benutzer und hat keine Root-Rechte.",
        "textLegacy": "Auf Ihrem Server gibt es noch die alten sudo-Regeln, über die der Web-Benutzer root werden konnte (certbot mit beliebigen Hooks, Kopieren einer beliebigen nginx-Konfiguration). Der Aktualisieren-Button kann sie nicht entfernen — er läuft ohne root. Führen Sie den Befehl unten einmal aus, um sie durch sichere Helfer zu ersetzen.",
        "step1": "Verbinden Sie sich per SSH als root oder als Benutzer mit sudo mit dem Server.",
        "step2": "Führen Sie diesen Befehl aus:",
        "step3": "Er lädt das Setup-Skript vom Tag dieses Releases auf GitHub (nicht aus dem Tracker-Ordner), ersetzt die sudo-Regeln, installiert die Helfer und beendet sich. Erneutes Ausführen ist unbedenklich. Das Tracking wird nicht unterbrochen.",
        "copy": "Kopieren",
        "copied": "Kopiert",
    ...
    "security": {
        ...
        "totpDesc": "Bei jeder Anmeldung einen Einmalcode aus der Authenticator-App abfragen.",
        "totpEnable": "Aktivieren",
        "totpDisable": "Deaktivieren",
        "totpEnabledBanner": "Die Zwei-Faktor-Authentifizierung ist aktiviert.",
        "totpDisabledBanner": "Die Zwei-Faktor-Authentifizierung ist deaktiviert.",
        "totpSecretLabel": "Geheimer Schlüssel",
        "totpOtpauthLabel": "otpauth-URI",
        "totpSecretHint": "Es gibt keinen QR-Code: Legen Sie das Konto in Ihrer Authenticator-App manuell an (Option „Setup-Schlüssel eingeben“) und fügen Sie das Geheimnis ein. Die otpauth-URI unten enthält dieselben Daten.",
        "totpCodeLabel": "Code aus der App",
        "totpCodePlaceholder": "6-stelliger Code",
        "totpCodeRequired": "Bitte den Code aus der App eingeben",
        "totpConfirm": "Bestätigen",
        "totpBadCode": "Ungültiger Code",
        "totpBadPassword": "Ungültiges Passwort",
        "totpDisablePasswordLabel": "Ihr Passwort",
        "totpDisablePasswordRequired": "Bitte das Passwort eingeben",
        "totpDisableHint": "Um die Zwei-Faktor-Authentifizierung zu deaktivieren, bestätigen Sie mit Ihrem Konto-Passwort.",
        "totpSetupError": "Einrichtung konnte nicht gestartet werden",
        "totpEnableError": "Zwei-Faktor-Authentifizierung konnte nicht aktiviert werden",
        "totpDisableError": "Zwei-Faktor-Authentifizierung konnte nicht deaktiviert werden",
        "currentPassword": "Aktuelles Passwort",
        "currentPasswordPlaceholder": "Aktuelles Passwort eingeben",
        "currentPasswordRequired": "Bitte das aktuelle Passwort eingeben, um es zu ändern",
        "currentPasswordInvalid": "Das aktuelle Passwort ist falsch",
        "crmIngestTitle": "Sicherheit des CRM-Eingangs",
        "crmIngestLabel": "Signatur-Geheimnis für den CRM-Eingang",
        "crmIngestHint": "Ist es gesetzt, nimmt /crm-ingest nur Anfragen mit dem Header X-Orbitra-Signature an (HMAC-SHA256 über den Body, hex). Leer bleibt der Endpunkt offen (ratenlimitiert).",
        "crmIngestSaved": "Gespeichert",
        "crmIngestError": "Speichern fehlgeschlagen",
        "vpnAsnLabel": "VPN-ASN als Bot-Signal werten",
        "vpnAsnHint": "VPN-/Proxy-Netze des Anbieters gelten als Bot-Signal. Deaktivieren Sie dies, wenn Ihre Zielgruppe überwiegend hinter kommerziellem VPN sitzt."
    },
    "streams": {
        "desktop": "Desktop",
        "mobile": "Mobil",
    ...
    "login": {
        ...
        "flowTitle": "Jeder Klick, in Echtzeit geroutet",
        "legendLive": "Zu einem aktiven Offer weitergeleitet",
        "legendSafe": "Zur sicheren Seite umgeleitet",
        "trackerOnline": "Tracker online",
        "trackerOffline": "Tracker nicht erreichbar",
        "trackerChecking": "Tracker wird geprüft…",
    ...
    "metrics": {
        ...
        "epc": "EPC",
        "epv": "EPV",
        "clicksHint": "Angebotsklicks: Besucher, die direkt zum Angebot geschickt wurden — Katalogangebot oder Direkt-URL des Streams — plus Landing-Aufrufe, bei denen der Besucher tatsächlich über den Angebotslink weiterging. Aktions-Streams und Safe Pages zählen nicht. Alle Hits sind Visitors",
        ...
        "timeOnLpHint": "Durchschnittliche Verweildauer auf der Landingpage über ALLE Besuche, auch die ohne Angebotsklick — gemessen vom Timer der Landingpage selbst",
        "lpBounceRateHint": "Anteil der gemessenen Besuche unter 5 Sekunden. Nenner sind gemessene Besuche, nicht Klicks",
        "lpScrollDepthHint": "Durchschnittlich tiefste erreichte Scroll-Position auf der Landingpage, 0-100 %",
        "lpMeasuredHint": "Besuche, die tatsächlich eine Zeit gemeldet haben — die Stichprobe hinter Verweildauer, Absprungrate und Scrolltiefe",
        ...
        "pwaScreenViewsHint": "Aufrufe der PWA-Trichter-Screens insgesamt: ein Besuch kann mehrere beitragen",
        ...
        "realRevenue": "Realer Umsatz",
        "realRoi": "Echter ROI",
        "marginHint": "Gewinn ÷ Umsatz × 100 %. Anders als ROI: Gewinn ÷ Kosten",
        "uniqueClicksHint": "Besucher, einmal pro Kampagne nach IP (oder IP + User Agent) im Eindeutigkeitsfenster der Kampagne gezählt",
        "conversionsHint": "Alle per Postback gemeldeten Conversions, jeder Status (Lead, Sale, abgelehnt, Trash)",
        "uniqueClicksStreamHint": "Besucher, einmal pro Stream gezählt: wer zwei Streams trifft, zählt in beiden",
        "uniqueClicksGlobalHint": "Besucher, einmal über alle Kampagnen des Trackers gezählt",
        "botsHint": "Hits, deren User Agent wie ein Crawler oder Tool aussieht (dieselben Signaturen wie beim Cloaking). Sie zählen auch in Visitors",
        "botRateHint": "Bots ÷ Visitors × 100 %",
        "proxiesHint": "Hits von Proxy-/VPN-/Tor-IPs. Benötigt die IP2Proxy-Datenbank (Einstellungen → Geo-Datenbanken)",
        "emptyReferrersHint": "Hits ohne Referrer — direkt eingegeben, In-App-Browser oder eine Quelle, die ihn entfernt",
        "crHint": "Conversions ÷ Klicks × 100 %"
    },
    "campaigns": {
    ...
    "editor": {
        ...
        "pbTest": {
            "title": "Postback-Prüfung",
            "run": "Test starten",
            "needSaved": "Speichern Sie die Kampagne, bevor Sie ihren Postback testen",
            "recorded": "„{from}“ als „{to}“ gespeichert — die Konversion ist angekommen",
            "noMapping": "„{from}“ wurde als „custom“ gespeichert — legen Sie einen Konversionstyp mit diesem Wert an (Einstellungen → Konversionstypen)",
            "notRecorded": "Konversion NICHT gespeichert (HTTP {code}) — siehe Systemprotokoll unten",
            "queued": "in die Warteschlange gestellt, der Worker sendet ihn",
            "filterMiss": "Statusfilter „{filter}“ lässt „{status}“ nicht durch — ergänzen Sie den Status in der Liste oben",
            "probeOk": "zugestellt: HTTP {code} · {ms} ms",
            "probeFail": "nicht zugestellt: {err}",
            "workerAlive": "Queue-Worker lebt (Ping vor {sec} s)",
        ...
        "streamStatsPeriod": "Zeitraum der Stream-Statistik",
        "streamStatsToday": "Heute",
        "streamStatsYesterday": "Gestern",
        "streamStats7d": "7 Tage",
        "streamStats30d": "30 Tage",
        "streamStatsRefresh": "Statistik aktualisieren",
        "streamStatsHint": "Besuche, die im Zeitraum in diesem Stream landeten, inkl. Bots und Safe Page",
        "streamStatsVisitors": "Besuche",
        "streamStatsUnique": "Uniq.",
        "streamStatsBots": "Bots",
        "streamStatsUnsaved": "Kampagne speichern, um Statistiken zu sehen",
        "streamStatsOther": "Weitere {visitors} Besuche ({share}%) sind gelöschten Streams oder alten Stream-IDs zugeordnet — vor v1.5.14 hat jedes Speichern die Streams neu angelegt.",
        "streamDefaultName": "Stream {n}",
    ...
    "postback": {
        ...
        "postbackDefaultKeyWarning": "Ihr Postback-Schlüssel ist der öffentliche Standardwert aus dem Repository. Gefälschte Conversions können an Ihren Tracker übermittelt werden. Generieren Sie einen neuen Schlüssel (CLI: php cli/generate_postback_key.php).",
    ...
    "clickDetails": {
        ...
        "fields": {
            ...
            "timeOnLp": "Zeit auf der Landingpage",
            "lpScroll": "Scrolltiefe",
    ...
    "systemSettings": {
        ...
        "updateNotify": "Über neue Versionen benachrichtigen",
        "updateNotifyDesc": "Prüft beim Laden des Panels, ob auf GitHub eine neuere Version vorliegt. Aus bedeutet, dass die Anfrage gar nicht gesendet wird — die Prüfung ist ein Netzwerkaufruf zu GitHub und kostet auf Hosts ohne Zugriff Wartezeit.",
    ...
    "botSettings": {
        ...
        "feedTitle": "IP-Bereiche von Rechenzentren und Crawlern",
        "feedMissing": "Noch nicht heruntergeladen — bis dahin kann das Cloaking die Bereichsebene nicht nutzen",
        "feedFresh": "Aktuell",
        "feedStale": "Älter als ein Tag",
        "feedUpdate": "Jetzt aktualisieren",
        "feedUpdating": "Wird aktualisiert…",
        "feedUpdateError": "Bereiche konnten nicht aktualisiert werden",
        "clearSourceHint": "Nur die Einträge aus dieser Quelle entfernen",
        "addIp": "IP hinzufügen",
    ...
    "logs": {
        ...
        "lastRecords": "Mit „Mehr laden“ weiter zurückblättern oder alles als CSV exportieren (bis zu 100.000 Zeilen, Filter werden angewendet).",
        "shownCount": "Angezeigte Einträge: {count}.",
        "loadMore": "Mehr laden",
        "exportCsv": "CSV exportieren",
        "exportHint": "Log dieses Tabs mit den aktuellen Filtern herunterladen (bis zu 100.000 Zeilen)",
        "colStream": "Stream",
        "filterByStream": "Stream-ID",
        "dateFrom": "Datum von",
        "dateTo": "Datum bis",
        "traffic": "Verkehr",
    ...
    "telegram": {
        ...
        "modeWebhook": "Webhook",
        "modePolling": "Abruf",
        "connectedPolling": "Telegram erreicht dieses Panel nicht über HTTPS, daher holt der Bot seine Nachrichten selbst ab. Mehr ist nicht zu tun.",
        "pollingReason": "Das Panel läuft nicht auf einer HTTPS-Domain, Telegram kann es also nicht aufrufen. Stattdessen fragt der Bot einmal pro Minute nach Nachrichten.",
        "pollActive": "Der Abruf läuft. Verbinden Sie unten einen Chat per Code.",
        "pollStale": "Der Abruf-Worker hat sich seit über 5 Minuten nicht gemeldet. Prüfe, ob sein Cron-Eintrag existiert, oder führe ihn einmal von Hand aus:",
        "webhookDeliveryError": "Telegram konnte ein Update nicht an dieses Panel zustellen:",
        "webhookUrl": "Webhook registriert unter:",
        "noChats": "Noch ist kein Chat mit dem Bot verbunden.",
        "noChatsHintWebhook": "Holen Sie unten einen Code und senden Sie ihn dem Bot. Passiert nichts, erreicht Telegram dieses Panel nicht — prüfen Sie den Webhook-Status oben.",
        "noChatsHintPolling": "Holen Sie unten einen Code, senden Sie ihn dem Bot und aktualisieren Sie in einer Minute — der Abruf läuft einmal pro Minute.",
        "domainHintTitle": "Öffne das Panel über eine Domain, nicht über die IP",
        "domainHintBody": "Telegram ruft den Webhook eines Bots nur über HTTPS auf, auf einem Domainnamen mit gültigem Zertifikat — zu einer IP-Adresse oder zu unverschlüsseltem http verbindet es sich nicht. Das Panel ist derzeit geöffnet unter",
        "domainHintFallback": "Richte eine Domain auf diesen Server, stelle im Bereich Domains ein Zertifikat dafür aus und öffne das Panel dann unter https://deine-domain/admin.php, um den Bot dort zu verbinden. Ohne Domain funktioniert der Bot ebenfalls — er holt seine Nachrichten einmal pro Minute selbst ab.",
        "pollingSwitchToDomain": "Zum Umstellen auf Webhook: Panel unter https://deine-domain/admin.php öffnen und den Bot neu verbinden. Aktuell ist es geöffnet unter",
        "connectedChats": "Verbundene Chats",
        "linkTitle": "Chat verbinden",
        "linkDesc": "Nur Chats, die mit einem Einmalcode verbunden wurden, können den Bot nutzen. Holen Sie einen Code und senden Sie ihn dem Bot aus dem Chat, den Sie verbinden möchten (privat oder Gruppe).",
        "linkGenerate": "Code holen",
        "linkSend": "Senden Sie dem Bot:",
        "linkOpenBot": "Bot öffnen",
        "linkExpires": "Der Code gilt einmal und 15 Minuten lang.",
        "linkError": "Code konnte nicht erstellt werden.",
        "removeChat": "Diesen Chat trennen",
        "removeChatConfirm": "{name} vom Bot trennen? Benachrichtigungen kommen erst wieder, wenn der Chat mit einem neuen Code verbunden wird.",
        "chatRemoved": "Chat getrennt.",
    ...
    "pixels": {
        ...
        "eventSourceUrlHint": "Wird als event_source_url an die Meta CAPI gesendet. Unterstützt {campaign_url}, {landing_url}, {offer_url}, {clickid} oder eine JSON-Map nach Meta-Ereignisname."
    },
    "appConfig": {
    ...
    "branding": {
        ...
        "terminal": "Terminal",
        "terminalDesc": "Phosphorgrün auf einer CRT - Scanlines, Vignette, Tabellenziffern",
        "aurora": "Aurora",
        "auroraDesc": "Kaltes Licht über tiefem Marineblau, ein Schimmer unter der Kopfzeile",
    ...
    "namecheap": {
        ...
        "price": "Preis",
        "priceEstimate": "Geschätzter Registrierungspreis für 1 Jahr. Den endgültigen Betrag legt Namecheap fest.",
        "priceUnavailable": "Preis nicht verfügbar. Prüfen Sie vor dem Kauf erneut die Verfügbarkeit.",
...
,
    ...
    "streamRefine": {
        ...
        "directUrlHelp": "Traffic wird direkt an diese URL weitergeleitet, ohne ein Angebot im Tracker erstellen zu müssen. Makros wie {subid}, {clickid}, {country}, {ip}, {sub_id_1}..{sub_id_30} werden unterstützt. Jeder Aufruf dieses Links zählt in den Berichten als Klick.",
    ...
    "dimensions": {
        ...
        "deletedStream": "Gelöschter Stream",
        "unnamedStream": "Unbenannter Stream",
        "country": "Land",
        "region": "Region",
        "city": "Stadt",
        "deviceType": "Gerätetyp",
        ...
        "day": "Datum (Tag)",
        "hour": "Stunde",
        "lpTime": "Bis zum Offer (Bucket)",
        "lpDwell": "Verweildauer LP (Bucket)",
        "pwaEntryScreen": "PWA: Einstiegs-Screen",
        "pwaLastScreen": "PWA: letzter Screen",
        "adCampaignId": "Werbekampagnen-ID",
        "adsetId": "Anzeigengruppen-ID",
        "adId": "Anzeigen-ID",
        "keyword": "Keyword",
    ...
    pwa: {
        ...
        funnelTitle: "Besuchstrichter (Screens)",
        funnelHint: "Screens eines Browser-Besuchs in fester Reihenfolge. Der erste aktive Schritt ist, was der Besucher zuerst sieht; ein Klick auf einen Schritt führt zum nächsten, der letzte startet die Installation. Aufrufe pro Screen werden automatisch erfasst.",
        funnelFirstBadge: "Erster Screen",
        funnelOff: "aus",
        funnelEdit: "Screen bearbeiten",
        funnelMoveUp: "Nach oben",
        funnelMoveDown: "Nach unten",
        funnelEnabledTitle: "Am Trichter beteiligt",
        funnelAddScreen: "Screen hinzufügen",
        funnelStepJs: "Tracking-Skript des Screens (JS)",
        funnelStepJsHint: "Läuft bei der ERSTEN Anzeige: Werbe-Pixel feuern nur, wenn der Besucher diesen Screen wirklich erreicht hat. Screen-Aufrufe werden automatisch gezählt.",
        funnelStepStore: "Store-Eintrag",
        funnelStepInstructions: "Installationsanleitung",
        funnelStepPush: "Push-Karte",
        funnelStepScreen: "Eigener Screen",
        funnelCardTitle: "Screen-Trichter",
        funnelCardLoadFailed: "Trichter-Statistik konnte nicht geladen werden",
        funnelCardClicks: "Besuche",
        funnelCardWithScreens: "Sahen einen Screen",
        funnelCardIntents: "Install-Klicks",
        funnelCardInstalls: "Installationen",
        funnelCardOfferClicks: "Offer-Klicks",
        funnelCardPushSubs: "Push-Abos",
        funnelCardNoData: "Noch keine Screen-Aufrufe. Trichter im Editor konfigurieren und Traffic schicken.",
        funnelCardScreens: "Screens",
        funnelCardScreen: "Screen",
        funnelCardViews: "Aufrufe",
        funnelCardUniq: "Unique",
        funnelCardEntry: "Einstieg",
        funnelCardExits: "Absprünge",
        funnelCardTransitions: "Übergänge",
        back: "Zurück",
        next: "Weiter",
        ...
        stepFlow: "Screens",
        stepStore: "Store",
        funnelAllOffHint: "Alle Schritte sind aus — der Besucher sieht den Store-Eintrag. Aktiviere einen Schritt oder füge einen eigenen Screen hinzu.",
        buttonTextFlowHint: "Wird als Schaltflächentext des Installationsanleitung-Schritts verwendet",
        iosFlow: "iOS-Ablauf",
