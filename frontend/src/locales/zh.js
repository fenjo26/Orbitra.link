export default {
    ...
    "telegram": {
        ...
        "pollActive": "轮询正在运行。请向机器人发送 /start。",
        "pollStale": "轮询进程已超过 5 分钟没有上报。请检查它的 cron 任务是否存在，或手动运行一次：",
        "webhookDeliveryError": "Telegram 无法向此面板投递更新：",
        "webhookUrl": "Webhook 已注册到：",
        "noChats": "还没有任何聊天向机器人发过消息。",
        "noChatsHintWebhook": "在 Telegram 中打开机器人并发送 /start。如果没有反应，说明 Telegram 无法访问此面板 —— 请查看上方的 webhook 状态。",
        "noChatsHintPolling": "在 Telegram 中打开机器人，发送 /start，一分钟后刷新 —— 轮询每分钟执行一次。",
