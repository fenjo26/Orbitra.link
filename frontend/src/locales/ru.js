export default {
    ...
    "telegram": {
        ...
        "pollActive": "Опрос работает. Отправьте боту /start.",
        ...
        "noChats": "Боту ещё никто не написал.",
        "noChatsHintWebhook": "Откройте бота в Telegram и отправьте /start. Если ничего не происходит — Telegram не достучался до панели, посмотрите статус вебхука выше.",
        "noChatsHintPolling": "Откройте бота в Telegram, отправьте /start и обновите через минуту — опрос идёт раз в минуту.",
