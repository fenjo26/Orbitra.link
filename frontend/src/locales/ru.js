export default {
    ...
    "metrics": {
        ...
        "epc": "EPC",
        "epv": "EPV",
        "clicksHint": "Клики по офферу: прямые переходы (без лендинга) плюс показы лендинга, где посетитель реально ушёл по ссылке на оффер. Не сырые хиты — это Visitors",
