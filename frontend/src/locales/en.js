export default {
    "serverSetup": {
        "title": "One-time server step needed",
        "text": "This version needs a one-time change on the server that the Update button cannot make on its own: it runs as the web user and has no root access.",
        "textLegacy": "Your server still has the old sudo rules that let the web user become root (certbot with arbitrary hooks, copying any nginx config). The Update button cannot remove them — it runs without root. Run the command below once to replace them with safe helpers.",
        "step1": "Connect to the server over SSH as root or a user with sudo.",
        "step2": "Run this command:",
        "step3": "It downloads the setup script from this release’s tag on GitHub (not from the tracker folder), replaces the sudo rules, installs the helpers and exits. Safe to run again. Tracking is not interrupted.",
        "copy": "Copy",
        "copied": "Copied",
    ...
    "security": {
        ...
        "totpDesc": "Require a one-time code from an authenticator app at every login.",
        "totpEnable": "Enable",
        "totpDisable": "Disable",
        "totpEnabledBanner": "Two-factor authentication is enabled.",
        "totpDisabledBanner": "Two-factor authentication is disabled.",
        "totpSecretLabel": "Secret key",
        "totpOtpauthLabel": "otpauth URI",
        "totpSecretHint": "No QR code is shown: add the account in your authenticator app manually (the “enter a setup key” option) and paste the secret. The otpauth URI below carries the same data.",
        "totpCodeLabel": "Code from the app",
        "totpCodePlaceholder": "6-digit code",
        "totpCodeRequired": "Enter the code from the app",
        "totpConfirm": "Confirm",
        "totpBadCode": "Invalid code",
        "totpBadPassword": "Invalid password",
        "totpDisablePasswordLabel": "Your password",
        "totpDisablePasswordRequired": "Enter your password",
        "totpDisableHint": "To turn two-factor authentication off, confirm with your account password.",
        "totpSetupError": "Could not start setup",
        "totpEnableError": "Could not enable two-factor authentication",
        "totpDisableError": "Could not disable two-factor authentication",
        ...
        "crmIngestTitle": "CRM intake security",
        "crmIngestLabel": "CRM ingest signature secret",
        "crmIngestHint": "If set, /crm-ingest accepts only requests carrying an X-Orbitra-Signature header (HMAC-SHA256 of the raw body, hex). Left empty, the endpoint stays open (rate-limited).",
        "crmIngestSaved": "Saved",
        "crmIngestError": "Could not save",
        "vpnAsnLabel": "Treat VPN ASN as a bot signal",
        "vpnAsnHint": "Provider VPN/proxy networks count as a bot signal. Turn this off if your audience largely sits behind commercial VPN."
    },
    "streams": {
        "desktop": "Desktop",
        "mobile": "Mobile",
    ...
    "login": {
        ...
        "flowTitle": "Every click, routed in real time",
        "legendLive": "Routed to a live offer",
        "legendSafe": "Diverted to the safe page",
        "trackerOnline": "Tracker online",
        "trackerOffline": "Tracker unreachable",
        "trackerChecking": "Checking tracker…",
    ...
    "metrics": {
        ...
        "epc": "EPC",
        "epv": "EPV",
        "clicksHint": "Offer clicks: visitors sent to the offer — a catalog offer or a stream Direct URL — straight away, plus landing views whose visitor actually left through the offer link. Action streams and safe pages are not clicks. The raw hit count is Visitors",
        ...
        "realLpClicksHint": "Landing views where the visitor actually left through the offer link (offer transition recorded) — not the pre-bound stream",
        "realOfferClicksHint": "Clicks that really reached the offer: direct clicks plus completed landing transitions",
        "realLpCtrHint": "(Real LP clicks / LP Views) × 100% — the honest CTA conversion of the landing",
        "timeOnLpHint": "Average time on the landing across EVERY visitor, the ones who never clicked the offer included — measured by the landing’s own timer",
        "lpBounceRateHint": "Share of measured visits shorter than 5 seconds. The denominator is measured visits, not clicks",
        "lpScrollDepthHint": "Average deepest scroll reached on the landing, 0-100%",
        "lpMeasuredHint": "Visits that actually reported a time — the sample behind Time on LP, bounce rate and scroll depth",
        "pwaIntentsHint": "Taps on the PWA landing Install button (before the browser prompt)",
        "pwaInstallsHint": "Install events recorded for the PWA landing, bots included",
        "realPwaInstallsHint": "PWA installs from non-bot clicks — appinstalled (Android) or first standalone open (iOS)",
        "pwaOpensHint": "Reopens of the installed PWA from the home screen (throttled to one per 10 min per click)",
        "pwaInstallRateHint": "(Real PWA installs / clicks) × 100% — on a PWA landing row this IS view→install; dash when zero installs",
        "pushSubscribedHint": "Clicks whose visitor accepted notifications and stored a subscription in the push base",
        "pwaScreenViewsHint": "Total PWA flow-screen views: every time a visitor was shown a funnel screen — one visit can contribute several",
        ...
        "realRevenue": "Real Revenue",
        "realRoi": "Real ROI",
        "marginHint": "Profit ÷ revenue × 100%. Differs from ROI, which is profit ÷ cost",
        "uniqueClicksHint": "Visitors counted once per campaign by IP (or IP + user agent) within the campaign uniqueness window",
        "conversionsHint": "Every conversion that came back by postback, any status (lead, sale, rejected, trash)",
        "uniqueClicksStreamHint": "Visitors counted once per stream: a visitor who hits two streams counts in each",
        "uniqueClicksGlobalHint": "Visitors counted once across all campaigns of the tracker",
        "botsHint": "Hits whose user agent looks like a crawler or a tool (the same signatures the cloak uses). They are counted in Visitors too",
        "botRateHint": "Bots ÷ Visitors × 100%",
        "proxiesHint": "Hits from proxy / VPN / Tor IPs. Needs the IP2Proxy database (Settings → Geo databases)",
        "emptyReferrersHint": "Hits with no referrer — typed-in, in-app browsers, or a source that strips it",
        "crHint": "Conversions ÷ Clicks × 100%"
    },
    "campaigns": {
    ...
    "editor": {
        ...
        "offerSelectionBeforeHint": "Counts every landing view as an offer transition — LP clicks / LP CTR read ~100% (legacy behavior)",
        "offerSelectionAfterHint": "Counts a transition only when the visitor actually clicks through to the offer — honest LP clicks / LP CTR and landing-time stats",
        ...
        "pbTest": {
            "title": "Postback check",
            "run": "Run test",
            "needSaved": "Save the campaign first to test its postback",
            "recorded": "\"{from}\" recorded as \"{to}\" — the conversion arrived",
            "noMapping": "\"{from}\" recorded as \"custom\" — add a conversion type with that value (Settings → Conversion types)",
            "notRecorded": "Conversion NOT recorded (HTTP {code}) — see the system log below",
            "queued": "queued, the worker will send it",
            "filterMiss": "statuses filter \"{filter}\" does not admit \"{status}\" — add the status to the list above",
            "probeOk": "delivered: HTTP {code} · {ms} ms",
            "probeFail": "not delivered: {err}",
            "workerAlive": "Queue worker is alive (pinged {sec}s ago)",
        ...
        "streamStatsPeriod": "Stream stats period",
        "streamStatsToday": "Today",
        "streamStatsYesterday": "Yesterday",
        "streamStats7d": "7 days",
        "streamStats30d": "30 days",
        "streamStatsRefresh": "Refresh stats",
        "streamStatsHint": "Visits that fell into this stream in the period, bots and safe page included",
        "streamStatsVisitors": "Visits",
        "streamStatsUnique": "Uniq.",
        "streamStatsBots": "Bots",
        "streamStatsUnsaved": "Save the campaign to see stats",
        "streamStatsOther": "{visitors} more visits ({share}%) are recorded on deleted streams or old stream IDs — before v1.5.14 every campaign save recreated the streams.",
    ...
    "domains": {
        ...
        "sslChainUnverified": "The certificate is issued, but the panel has not yet confirmed the chain: the certificate file is not readable by the panel and the domain is not answering over HTTPS yet. The check repeats automatically — this is a warning, not a failure.",
        "sslChainCheckPending": "Chain check pending",
        ...
        "sslEnvNoSudoCertbot": "Certbot is installed, but the web server user cannot run the certificate helper through sudo, so the panel cannot issue certificates. Run once as root: sudo bash /var/www/orbitra/cli/server_setup.sh",
    ...
    "admin": {
        ...
        "diskCritical": "Critically low disk space! Free up space.",
        "diskWarning": "Low disk space. Consider clearing old logs.",
        "cpuCritical": "High CPU load. Consider upgrading your server.",
        "cpuWarning": "Elevated CPU load.",
        "ramCritical": "Critically low memory!",
        "ramWarning": "Low available memory.",
        "dbOver500": "Database exceeds 500MB. Consider switching to MySQL for better performance.",
        "dbGrowing": "The database is growing. Consider switching to MySQL once it reaches 500MB.",
        "branding": "Personalization",
        "geoProfiles": "Geo Profiles",
        "postback": "Postback URL",
        "settings": "Settings",
    ...
    "postback": {
        ...
        "postbackDefaultKeyWarning": "Your postback key is the public default from the repository. Fake conversions can be posted to your tracker. Generate a new key (CLI: php cli/generate_postback_key.php).",
    ...
    "clickDetails": {
        ...
        "fields": {
            ...
            "landingAt": "Landing Shown At",
            "offerAt": "Offer Transition At",
            "timeToOffer": "Time to Offer",
            "timeOnLp": "Time on Landing",
            "lpScroll": "Scroll Depth",
    ...
    "systemSettings": {
        ...
        "updateNotify": "Notify me about new versions",
        "updateNotifyDesc": "Checks GitHub for a newer release when the panel loads. Off means the request is not made at all — the check is a network call to GitHub, and it costs a wait on hosts that cannot reach it.",
    ...
    "users": {
        ...
        "resourceLogs": "Logs",
        "campaignItems": "Assigned campaigns (visible with Own + Selected / Selected access)",
    ...
    "botSettings": {
        ...
        "fillName": "Enter name",
        "clearAll": "Clear All",
        "feedTitle": "Datacenter and crawler IP ranges",
        "feedMissing": "Not downloaded yet — cloaking cannot use the range layer until it is",
        "feedFresh": "Up to date",
        "feedStale": "Older than a day",
        "feedUpdate": "Update now",
        "feedUpdating": "Updating…",
        "feedUpdateError": "Could not update the ranges",
        "clearSourceHint": "Remove only the entries from this source",
        "addIp": "Add IP",
    ...
    "logs": {
        "title": "System Logs",
        "lastRecords": "Use \"Load more\" to page further back, or export everything to CSV (up to 100,000 rows, filters applied).",
        "shownCount": "Records shown: {count}.",
        "loadMore": "Load more",
        "exportCsv": "Export CSV",
        "exportHint": "Download this tab's log with the current filters (up to 100,000 rows)",
        "colStream": "Stream",
    ...
    "telegram": {
        ...
        "modeWebhook": "webhook",
        "modePolling": "polling",
        "connectedPolling": "Telegram cannot reach this panel over HTTPS, so the bot fetches its messages instead. Nothing else to do.",
        "pollingReason": "The panel is not on an HTTPS domain, so Telegram cannot call it back. The bot asks Telegram for messages once a minute instead.",
        "pollActive": "The poller is running. Connect a chat with a code below.",
        "pollStale": "The poller has not reported in for over 5 minutes. Check that its cron line exists, or run it once by hand:",
        "webhookDeliveryError": "Telegram could not deliver an update to this panel:",
        "webhookUrl": "Webhook registered at:",
        "noChats": "No chat is connected to the bot yet.",
        "noChatsHintWebhook": "Get a code below and send it to the bot. If nothing happens, Telegram is not reaching this panel — check the webhook status above.",
        "noChatsHintPolling": "Get a code below, send it to the bot, then refresh in a minute — the poller checks once a minute.",
        "domainHintTitle": "Open the panel on a domain, not by IP",
        "domainHintBody": "Telegram calls a bot's webhook back only over HTTPS, on a domain name with a valid certificate — it will not connect to an IP address or to plain http. The panel is currently open at",
        "domainHintFallback": "Point a domain at this server, issue a certificate for it in the Domains section, then open the panel at https://your-domain/admin.php and connect the bot there. Without a domain the bot still works — it fetches its messages itself, once a minute.",
        "pollingSwitchToDomain": "To switch to a webhook: open the panel at https://your-domain/admin.php and reconnect the bot. Right now it is open at",
        "connectedChats": "Connected chats",
        "linkTitle": "Connect a chat",
        "linkDesc": "Only chats connected with a one-time code can use the bot. Get a code and send it to the bot from the chat you want to connect (a private chat or a group).",
        "linkGenerate": "Get a code",
        "linkSend": "Send this to the bot:",
        "linkOpenBot": "Open the bot",
        "linkExpires": "The code works once, for 15 minutes.",
        "linkError": "Could not create a code.",
        "removeChat": "Disconnect this chat",
        "removeChatConfirm": "Disconnect {name} from the bot? It will stop getting notifications until it is connected again with a new code.",
        "chatRemoved": "Chat disconnected.",
    ...
    "pixels": {
        ...
        "eventSourceUrlHint": "Sent to Meta CAPI as event_source_url. Supports {campaign_url}, {landing_url}, {offer_url}, {clickid}, or a JSON map keyed by Meta event name."
    },
    "appConfig": {
        "title": "App Config",
    ...
    "branding": {
        ...
        "terminal": "Terminal",
        "terminalDesc": "Phosphor green on a CRT - scanlines, vignette, tabular figures",
        "aurora": "Aurora",
        "auroraDesc": "Cold light drifting over deep navy, a bloom under the navbar",
        "custom": "Custom Theme",
    ...
    "update": {
        "gitUpdateComposerNote": "Line 3 fetches a pinned Composer (2.10.3) only when the server has no composer.phar yet — installs from before v1.6.0 keep theirs. The in-panel update button does the same automatically and verifies the checksum.",
...
,
    ...
    "streamRefine": {
        ...
        "directUrlHelp": "Traffic will be redirected directly to this URL without having to create an offer in the tracker. Macros like {subid}, {clickid}, {country}, {ip}, {sub_id_1}..{sub_id_30} are supported. Every hop to this link counts as a click in reports.",
        "detectionLayers": "Detection Layers",
    ...
    "dimensions": {
        ...
        "deletedStream": "Deleted stream",
        "unnamedStream": "Unnamed stream",
        "country": "Country",
        "region": "Region",
        "city": "City",
        "deviceType": "Device Type",
        ...
        "day": "Date (Day)",
        "hour": "Hour",
        "lpTime": "Time to offer (bucket)",
        "lpDwell": "Time on LP (bucket)",
        "pwaEntryScreen": "PWA entry screen",
        "pwaLastScreen": "PWA last screen",
        "adCampaignId": "Ad Campaign ID",
        "adsetId": "AdSet ID",
        "adId": "Ad ID",
        "keyword": "Keyword",
    ...
    "media": {
        ...
        "subtitle": "Shared image library — pick from it in offers, landings and any file picker.",
        "upload": "Upload images",
        "uploadHint": "Click or drop images here (webp, jpg, png, gif · up to 10 MB)",
        "uploadingCount": "Uploading ({n})…",
        "allFiles": "All files",
        ...
        "folderNamePlaceholder": "Folder name (up to 50 characters)",
        "renameFolder": "Rename folder",
        "deleteFolder": "Delete folder",
        "deleteFolderConfirm": "Delete the folder \"{name}\"? Files inside stay in the library (root).",
        "selected": "Selected: {n}",
        "move": "Move",
        "moveTitle": "Move to folder",
        "noFolder": "No folder (root)",
        "restore": "Restore",
        "deselectHint": "Click to deselect",
        ...
        "totalFiles": "Files: {n}",
        "pageOf": "Page {p} of {n}",
        "deniedNotice": "{n} files belong to another user and were skipped.",
        "pickerTitle": "Choose an image",
        "selectButton": "Select",
        "selectCount": "Select ({n})",
        "loadMore": "Show more",
        "cropButton": "Crop",
        "cropApply": "Apply and upload",
        "cropSkip": "Skip",
        "cropHint": "Drag the frame, resize from the corners — result is exactly {w}×{h}.",
        "exactSize": "Exact size",
        "croppable": "Can be cropped to {w}×{h}",
        "tooSmall": "Too small for {w}×{h}",
        "replaceFromGallery": "Replace from gallery",
        "insertImage": "Insert image",
        "err_extension": "This file type is not allowed",
        "err_not_image": "The file is not a valid image",
        "err_too_large": "File too large (max 10 MB)",
        "err_upload": "Upload failed",
        "err_store": "Could not store the file",
        "err_no_files": "No files received",
        "err_bad_request": "Bad request",
        "err_folder_name": "Folder name must be 1–50 characters",
        "err_folder_exists": "A folder with that name already exists"
    },
    pwa: {
        title: "PWA Landing",
        updateAvailable: "Update available",
        reload: "Reload",
        loadFailed: "Failed to load the PWA config",
        nameRequired: "Internal name and app name are required",
        saveFailed: "PWA save failed",
        saving: "Saving & generating statics…",
        openPreview: "Open preview",
        copyLink: "Copy link",
        linkServerAddress: "server address — bind a domain for ads",
        stepGeneral: "General",
        stepReviews: "Reviews",
        preview: "Preview",
        presets: "Presets",
        presetsHint: "A preset fills design & sample content — your names stay as typed",
        dragHint: "Drag reviews by the handle to reorder",
        funnelTitle: "Visit funnel (screens)",
        funnelHint: "Ordered screens of a browser visit. The first enabled step is what the visitor sees first; a CTA on a step moves to the next one, the last step runs the install prompt. Views per screen are tracked automatically.",
        funnelFirstBadge: "First screen",
        funnelOff: "off",
        funnelEdit: "Edit screen",
        funnelMoveUp: "Move up",
        funnelMoveDown: "Move down",
        funnelEnabledTitle: "Include in the funnel",
        funnelAddScreen: "Add screen",
        funnelStepJs: "Screen tracking script (JS)",
        funnelStepJsHint: "Runs on the screen's FIRST show — ad pixels fire only if the visitor actually reached this screen. Screen views are recorded automatically.",
        funnelStepStore: "Store listing",
        funnelStepInstructions: "Install instructions",
        funnelStepPush: "Push opt-in card",
        funnelStepScreen: "Custom screen",
        funnelCardTitle: "Screen funnel",
        funnelCardLoadFailed: "Failed to load funnel stats",
        funnelCardClicks: "Visits",
        funnelCardWithScreens: "Seen a screen",
        funnelCardIntents: "Install intents",
        funnelCardInstalls: "Installs",
        funnelCardOfferClicks: "Offer clicks",
        funnelCardPushSubs: "Push subs",
        funnelCardNoData: "No screen views recorded yet. Configure the funnel in the editor and send traffic.",
        funnelCardScreens: "Screens",
        funnelCardScreen: "Screen",
        funnelCardViews: "Views",
        funnelCardUniq: "Unique",
        funnelCardEntry: "Entry",
        funnelCardExits: "Exits",
        funnelCardTransitions: "Transitions",
        back: "Back",
        next: "Next",
        sectionBasic: "Basic",
        internalName: "Internal name",
        internalNameHint: "For identification in the panel; visitors never see it",
        state: "Status",
        appName: "App name",
        developer: "Developer",
        category: "Category",
        language: "PWA language",
        languageHint: "Any code — pt, pt-BR, ar… Unknown languages fall back to English for built-in texts (instructions, prompts)",
        pushEnabled: "Push notifications",
        pushEnabledHint: "After install, the app offers notifications once — subscribers are a free re-engagement channel and typically lift conversions. Requires keys from the Push Base page.",
        buttonText: "Button text",
        downloads: "Downloads",
        adsLabel: "Ads label",
        version: "Version",
        sectionMedia: "Icon & screenshots",
        appAction: "App behavior (installed)",
        appActionHint: "What a visitor sees when opening the installed app from the home screen — the money step of the funnel",
        appActionStore: "Show the store",
        appActionOffer: "Redirect to the offer",
        appActionCampaign: "Redirect to the campaign",
        appActionCampaignHint: "The visitor enters the selected campaign through the tracker — its streams and rotation distribute the traffic; {subid} keeps conversion attribution",
        appActionScreen: "Custom app screen",
        appScreenTitle: "Screen title",
        appScreenText: "Screen text",
        ...
        screens: "Screenshots",
        screensHint: "Up to 10 (PNG/JPEG/WebP)",
        addScreens: "Add screenshots",
        sectionContent: "Content",
        description: "Description",
        descriptionHint: "Macros: {value} — app name, {value1}/{value2} — developer",
        tags: "Tags",
        tagsHint: "Comma-separated keywords under the description",
        rating: "Ratings distribution",
        ratingAvg: "average",
        sectionComments: "Reviews",
        commentName: "Name",
        commentDate: "Date",
        commentText: "Review text",
        commentReply: "Developer reply",
        addComment: "Add review",
        sectionDesign: "Appearance",
        storeStyle: "Store style",
        storeStyleAuto: "Auto (iOS → App Store, Android → Google Play)",
        ...
        preloader: "Preloader",
        showHeader: "Search header",
        bottomMenu: "Bottom menu",
        showShare: "Share buttons",
        sectionFunnel: "Funnel & redirects",
        stepFlow: "Screens",
        stepStore: "Store",
        funnelAllOffHint: "Every step is off — a cold visitor will see the store listing. Turn a step on or add your own screen.",
        buttonTextFlowHint: "Used as the button label on the install-instructions step",
        iosFlow: "iOS flow",
        iosFlowHint: "iOS has no native install prompt — show the Add to Home Screen instruction",
        iosFlowDefault: "Default",
        iosFlowInstruction: "Instruction",
        autoRedirect: "Auto-redirect after open",
        declineRedirect: "Redirect on install decline",
        installRedirect: "Redirect after install",
        installRedirectHint: "0 = immediately after the install event",
        timerOff: "Off",
        timerImmediate: "Immediately",
        supportEnabled: "Support block",
        supportEmail: "Support email",
        supportAddress: "Support address",
        whatsNew: "What's new block",
        whatsNewText: "What's new text",
        previewStore: "Store",
        previewApp: "App screen",
        actionTarget: "Target destination",
        actionTargetHint: "Where visitors are sent on CTA button click, auto-redirect, or installed app launch",
        targetOffer: "Redirect to Offer (Stream)",
        targetCampaign: "Redirect to Campaign",
        targetUrl: "Direct URL",
        targetNotFound: "404 Not Found",
        targetCampaignLabel: "Target campaign",
        targetCampaignPlaceholder: "-- Select target campaign --",
        targetUrlLabel: "Destination URL",
        targetUrlPlaceholder: "https://example.com/?subid={subid}",
        targetNotFoundHint: "Visitors will receive an HTTP 404 Not Found response",
        appScreenType: "In-App screen layout",
        appScreenTypeHint: "Choose between a native dashboard, built-in interactive mini-games, or your own custom HTML5 game/script",
        screenTypeLobby: "Native App Lobby (Dashboard)",
        screenTypeSlot: "Interactive 777 Slot Game",
        screenTypeWheel: "Lucky Bonus Wheel",
        screenTypeCustom: "Custom HTML & JavaScript",
        customHtmlLabel: "Custom HTML Markup",
        customHtmlPlaceholder: "<div id=\"game-container\">...</div>",
        customJsLabel: "Custom JavaScript Code",
        customJsPlaceholder: "// Call window.orbitraRedirect() to trigger redirect\nfunction onGameWin() {\n  window.orbitraRedirect();\n}",
        customJsTip: "Call window.orbitraRedirect() or add class=\"install-trigger\" anywhere in your game to trigger the funnel transition.",
        insertSlotBoilerplate: "Insert Slot Template",
        insertWheelBoilerplate: "Insert Roulette/Wheel Template",
        sectionCustomScripts: "Custom Scripts, Styles & Tracking",
        customCssLabel: "Custom CSS Styles & Animations",
        customCssHint: "Override colors, gradients, layout or define custom CSS @keyframes animations",
        customCssPlaceholder: "/* Custom CSS & keyframe animations */\n.install-btn { transform: scale(1.02); }",
        customHeadLabel: "Custom <head> code / Tracking Pixels",
        customHeadPlaceholder: "<!-- FB Pixel, TikTok Pixel, Google Tag Manager, custom fonts/meta -->",
        customJsGlobalLabel: "Custom Global JavaScript",
        customJsGlobalPlaceholder: "// Custom scripts executed before </body>",
        animationGlow: "Shimmer & Button Glow (CTR Booster)",
        showLiveBadge: "Live Active Players Counter",
        soundEnabled: "Casino / Game Sound Effects",
        vibrationEnabled: "Haptic Vibration Feedback",
        domainLabel: "Domain",
        ...
        offerLabel: "Offer",
        offerNone: "— Not selected —",
        offerSaving: "Saving offer…",
        offerError: "Failed to save the offer binding",
    },
    push: {
        navLabel: "Push Base",
        noAccess: "No access",
...
vapidHint: "Generated once and wired automatically — every PWA receives the public key when its page is served. Nothing to paste anywhere.",
        ...
        endpoint: "Endpoint",
        status: "Status",
        empty: "No subscribers yet — install the PWA and accept notifications",
        statusLive: "Live",
        statusDead: "Dead",
        delete: "Delete",
        ...
        prev: "Prev",
        next: "Next",
        loadFailed: "Failed to load the push base",
        tabSubscribers: "Subscribers",
        tabMessages: "Messages",
        newMessage: "New message",
        editMessage: "Edit message",
        messagesEmpty: "No messages yet — create one and press Send now",
        messageTitle: "Title",
        messageTitlePlaceholder: "Your donation is doubled today",
        messageText: "Text",
        messageTextPlaceholder: "Text shown in the notification, up to 400 characters",
        ...
        segment: "Segment",
        segmentAll: "All subscribers",
        segmentReg0: "No registrations",
        segmentReg1Dep0: "Registered, no deposits",
        segmentReg1Dep1: "Registered with deposits",
        kind: "Type",
        kindManual: "Manual",
        kindEvent: "Event",
        event: "Event",
        ...
        delay: "Delay, seconds",
        delayUnit: "s",
        delayHint: "The push goes out this many seconds after the event fires",
        sent: "Sent",
        failed: "Failed",
        queued: "In queue",
        workerStalled: "Messages are queued but the delivery worker is not running — nothing will be sent. Add this line to the www-data crontab:",
        contactLabel: "Sender contact (VAPID sub)",
        contactHint: "mailto: or https: — the address push services can reach you at. Apple rejects the built-in placeholder and answers 403, so set a real one before sending to iPhones.",
        contactInvalid: "The contact must start with mailto: or https:",
        lastFailCode: "Last error",
        failCodeNoReply: "no reply",
        sendNow: "Send now",
        confirmSend: "Queue this message for every matching active subscriber?",
        sendQueued: "Queued:",
        messageDeleteConfirm: "Delete this message? The queue and delivery log are kept.",
        keysExist: "Keys already exist — confirm the replacement to rotate them",
        titleTextRequired: "Title and text are required",
