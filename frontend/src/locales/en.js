export default {
    ...
    "feedback": {
        ...
        "partnerCloakinghouseDesc": "Cloaking.House is a cloud-based cloaking service for filtering and routing traffic. Configure GEO, devices, OS, browsers, VPNs, and other traffic parameters with ease."
    },
    "profile": {
    ...
    "telegram": {
        ...
        "pollActive": "The poller is running. Send /start to the bot.",
        ...
        "noChats": "No chat has written to the bot yet.",
        "noChatsHintWebhook": "Open the bot in Telegram and send /start. If nothing happens, Telegram is not reaching this panel — check the webhook status above.",
        "noChatsHintPolling": "Open the bot in Telegram and send /start, then refresh in a minute — the poller checks once a minute.",
