export default {
    ...
    "feedback": {
        ...
        "partnerCloakinghouseDesc": "Cloaking.House — хмарний клоакінг-сервіс для фільтрації та розподілу трафіку. Підтримує налаштування GEO, пристроїв, ОС, браузерів, VPN та інших параметрів."
    },
    "profile": {
    ...
    "telegram": {
        ...
        "pollActive": "Опитування працює. Надішліть боту /start.",
        ...
        "noChats": "Боту ще ніхто не написав.",
        "noChatsHintWebhook": "Відкрийте бота в Telegram і надішліть /start. Якщо нічого не відбувається — Telegram не дістався до панелі, перегляньте статус вебхука вище.",
        "noChatsHintPolling": "Відкрийте бота в Telegram, надішліть /start і оновіть за хвилину — опитування йде раз на хвилину.",
