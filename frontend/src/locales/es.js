export default {
    "serverSetup": {
        "title": "Hace falta un paso único en el servidor",
        "text": "Esta versión necesita un cambio único en el servidor que el botón Actualizar no puede hacer por sí solo: se ejecuta como el usuario web y no tiene acceso root.",
        "textLegacy": "Tu servidor aún tiene las reglas sudo antiguas que permitían al usuario web convertirse en root (certbot con hooks arbitrarios, copiar cualquier configuración de nginx). El botón Actualizar no puede quitarlas: se ejecuta sin root. Ejecuta el comando de abajo una vez para sustituirlas por ayudantes seguros.",
        "step1": "Conéctate al servidor por SSH como root o con un usuario con sudo.",
        "step2": "Ejecuta este comando:",
        "step3": "Descarga el script de configuración desde la etiqueta de esta versión en GitHub (no desde la carpeta del tracker), sustituye las reglas sudo, instala los ayudantes y termina. Se puede ejecutar de nuevo sin riesgo. El tracking no se interrumpe.",
        "copy": "Copiar",
        "copied": "Copiado",
    ...
    "security": {
        ...
        "totpDesc": "Pedir un código de un solo uso de la app de autenticación en cada inicio de sesión.",
        "totpEnable": "Activar",
        "totpDisable": "Desactivar",
        "totpEnabledBanner": "La autenticación en dos pasos está activada.",
        "totpDisabledBanner": "La autenticación en dos pasos está desactivada.",
        "totpSecretLabel": "Clave secreta",
        "totpOtpauthLabel": "URI otpauth",
        "totpSecretHint": "No hay código QR: añade la cuenta manualmente en tu app de autenticación (opción «introducir clave de configuración») y pega el secreto. La URI otpauth de abajo contiene los mismos datos.",
        "totpCodeLabel": "Código de la app",
        "totpCodePlaceholder": "Código de 6 dígitos",
        "totpCodeRequired": "Introduce el código de la app",
        "totpConfirm": "Confirmar",
        "totpBadCode": "Código no válido",
        "totpBadPassword": "Contraseña no válida",
        "totpDisablePasswordLabel": "Tu contraseña",
        "totpDisablePasswordRequired": "Introduce tu contraseña",
        "totpDisableHint": "Para desactivar la autenticación en dos pasos, confírmalo con la contraseña de tu cuenta.",
        "totpSetupError": "No se pudo iniciar la configuración",
        "totpEnableError": "No se pudo activar la autenticación en dos pasos",
        "totpDisableError": "No se pudo desactivar la autenticación en dos pasos",
        "currentPassword": "Contraseña actual",
        "currentPasswordPlaceholder": "Introduce la contraseña actual",
        "currentPasswordRequired": "Introduce la contraseña actual para cambiarla",
        "currentPasswordInvalid": "La contraseña actual no es correcta",
        "crmIngestTitle": "Seguridad de recepción en CRM",
        "crmIngestLabel": "Secreto de firma de recepción CRM",
        "crmIngestHint": "Si se define, /crm-ingest solo acepta peticiones con la cabecera X-Orbitra-Signature (HMAC-SHA256 del cuerpo, hex). Vacío: el endpoint queda abierto (con límite de frecuencia).",
        "crmIngestSaved": "Guardado",
        "crmIngestError": "No se pudo guardar",
        "vpnAsnLabel": "Tratar el ASN de VPN como señal de bot",
        "vpnAsnHint": "Las redes VPN/proxy del proveedor cuentan como señal de bot. Desactívalo si tu audiencia usa masivamente VPN comerciales."
    },
    "streams": {
        "desktop": "Escritorio",
        "mobile": "Móvil",
    ...
    "feedback": {
        ...
        "partnersDesc": "Servicios que recomendamos para la compra de medios y el trabajo diario.",
        "partnerPay2houseDesc": "Tarjetas virtuales para anuncios de Facebook, Google y TikTok, además de servicios en línea.",
        "partnerGroupbuyseoDesc": "Acceso compartido a herramientas de SEO y marketing: Ahrefs, Semrush, ChatGPT Plus y más."
    },
    "profile": {
    ...
    "login": {
        ...
        "flowTitle": "Cada clic, enrutado en tiempo real",
        "legendLive": "Enviado a una oferta activa",
        "legendSafe": "Desviado a la página segura",
        "trackerOnline": "Tracker en línea",
        "trackerOffline": "Tracker inaccesible",
        "trackerChecking": "Comprobando el tracker…",
    ...
    "metrics": {
        ...
        "epc": "EPC",
        "epv": "EPV",
        "clicksHint": "Clics de oferta: visitantes enviados a la oferta — del catálogo o por la URL directa del flujo — de inmediato, más vistas de landing cuyo visitante salió realmente por el enlace de la oferta. Los flujos de acción y las safe pages no son clics. El total de hits es Visitors",
        "visitorsHint": "Todos los impactos en la URL de la campaña — vistas de landing, saltos directos y todo lo demás; el denominador de CPV/EPV",
        ...
        "realLpClicksHint": "Vistas del landing donde el visitante realmente salió por el enlace de la oferta (transición registrada) — no la oferta preasignada por el stream",
        "realOfferClicksHint": "Clics que realmente llegaron a la oferta: directos más transiciones completadas desde el landing",
        "realLpCtrHint": "(Clics LP reales / Vistas LP) × 100% — la conversión CTA honesta del landing",
        "timeOnLpHint": "Tiempo medio en la landing de TODAS las visitas, incluidas las que nunca pulsaron la oferta — lo mide el temporizador de la propia landing",
        "lpBounceRateHint": "Porcentaje de visitas medidas de menos de 5 segundos. El denominador son las visitas medidas, no los clics",
        "lpScrollDepthHint": "Profundidad media de scroll alcanzada en la landing, 0-100%",
        "lpMeasuredHint": "Visitas que realmente informaron un tiempo — la muestra detrás de Tiempo en LP, rebote y scroll",
        "pwaIntentsHint": "Toques en el botón Instalar del PWA landing (antes del aviso del navegador)",
        "pwaInstallsHint": "Eventos de instalación del PWA landing, incluidos los bots",
        "realPwaInstallsHint": "Instalaciones PWA de clics no-bot — appinstalled (Android) o primera apertura standalone (iOS)",
        "pwaOpensHint": "Reaperturas del PWA instalado desde la pantalla de inicio (máximo una cada 10 min por clic)",
        "pwaInstallRateHint": "(Instalaciones PWA reales / clics) × 100% — en una fila de PWA landing esto ES vista→instalación; guion si hay cero instalaciones",
        "pushSubscribedHint": "Clics donde el visitante aceptó las notificaciones y la suscripción quedó guardada en la base",
        "pwaScreenViewsHint": "Vistas totales de pantallas del embudo PWA: cada vez que se muestra una pantalla — una visita puede contribuir varias",
        ...
        "realRevenue": "Ingresos reales",
        "realRoi": "ROI real",
        "marginHint": "Beneficio ÷ ingresos × 100%. Distinto del ROI: beneficio ÷ coste",
        "uniqueClicksHint": "Visitantes contados una vez por campaña por IP (o IP + user agent) dentro de la ventana de unicidad de la campaña",
        "conversionsHint": "Todas las conversiones recibidas por postback, en cualquier estado (lead, venta, rechazada, trash)",
        "uniqueClicksStreamHint": "Visitantes contados una vez por flujo: quien entra en dos flujos cuenta en cada uno",
        "uniqueClicksGlobalHint": "Visitantes contados una vez en todas las campañas del tracker",
        "botsHint": "Hits cuyo user agent parece un crawler o herramienta (las mismas firmas que usa el cloak). También cuentan en Visitors",
        "botRateHint": "Bots ÷ Visitors × 100%",
        "proxiesHint": "Hits desde IP de proxy / VPN / Tor. Requiere la base IP2Proxy (Ajustes → Bases geo)",
        "emptyReferrersHint": "Hits sin referrer — escritos a mano, navegadores in-app o una fuente que lo elimina",
        "crHint": "Conversiones ÷ Clics × 100%"
    },
    "campaigns": {
    ...
    "editor": {
        ...
        "offerSelectionBeforeHint": "Cuenta cada vista del landing como transición a la oferta — los clics LP / CTR LP leen ~100% (comportamiento anterior)",
        "offerSelectionAfterHint": "La transición solo se cuenta cuando el visitante realmente hace clic hacia la oferta — clics LP / CTR LP honestos y estadísticas de tiempo en el landing",
        ...
        "pbTest": {
            "title": "Comprobación de postback",
            "run": "Ejecutar prueba",
            "needSaved": "Guarda primero la campaña para probar su postback",
            "recorded": "«{from}» registrado como «{to}» — la conversión llegó",
            "noMapping": "«{from}» registrado como «custom» — crea un tipo de conversión con ese valor (Ajustes → Tipos de conversión)",
            "notRecorded": "La conversión NO se registró (HTTP {code}) — mira el registro del sistema abajo",
            "queued": "encolado, lo enviará el worker",
            "filterMiss": "el filtro de estados «{filter}» no admite «{status}» — añade el estado en la lista de arriba",
            "probeOk": "entregado: HTTP {code} · {ms} ms",
            "probeFail": "no entregado: {err}",
            "workerAlive": "El worker de cola está vivo (ping hace {sec} s)",
        ...
        "streamStatsPeriod": "Periodo de estadísticas de flujos",
        "streamStatsToday": "Hoy",
        "streamStatsYesterday": "Ayer",
        "streamStats7d": "7 días",
        "streamStats30d": "30 días",
        "streamStatsRefresh": "Actualizar estadísticas",
        "streamStatsHint": "Visitas que cayeron en este flujo en el periodo, incluidos bots y safe page",
        "streamStatsVisitors": "Visitas",
        "streamStatsUnique": "Únic.",
        "streamStatsBots": "Bots",
        "streamStatsUnsaved": "Guarde la campaña para ver estadísticas",
        "streamStatsOther": "{visitors} visitas más ({share}%) están registradas en flujos eliminados o IDs antiguos — antes de v1.5.14 cada guardado recreaba los flujos.",
        "streamDefaultName": "Flujo {n}",
    ...
    "domains": {
        ...
        "sslCustom": "Propio",
        "sslSelfSigned": "Autofirmado",
        "sslModeAutoHint": "Modo no elegido: Orbitra decide — Cloudflare para dominios proxied, Let\u2019s Encrypt en el resto.",
        ...
        "sslCloudflareStatus": "SSL de Cloudflare (dominio con proxy)",
        ...
        "sslChainUnreadable": "El certificado está emitido y el sitio funciona, pero el panel no puede leer el archivo del certificado para verificar la cadena: revise el acceso del usuario web a /etc/letsencrypt. Es un aviso, no un error.",
        "sslChainUnverified": "El certificado está emitido, pero el panel aún no ha confirmado la cadena: el archivo del certificado no es legible para el panel y el dominio todavía no responde por HTTPS. La comprobación se repetirá automáticamente: es un aviso, no un error.",
        "sslChainCheckPending": "Cadena sin confirmar",
        "sslDeleteFailed": "No se pudo eliminar el certificado antiguo antes de reemitir. Compruebe que el usuario web puede ejecutar sudo certbot.",
        ...
        "sslAwaitingDnsSwitch": "El DNS todavía apunta a Cloudflare, por lo que aún no se puede emitir el certificado del origen. El indicador de proxy se restauró para coincidir con el DNS; se aclara solo cuando el registro se propague.",
    ...
    "admin": {
        ...
        "diskCritical": "¡Espacio en disco críticamente bajo! Libera espacio.",
        "diskWarning": "Poco espacio en disco. Se recomienda limpiar los registros antiguos.",
        "cpuCritical": "Carga de CPU alta. Considera actualizar el servidor.",
        "cpuWarning": "Carga de CPU elevada.",
        "ramCritical": "¡Memoria RAM críticamente baja!",
        "ramWarning": "Poca memoria RAM disponible.",
        "dbOver500": "La base de datos supera los 500MB. Considera cambiar a MySQL para mejorar el rendimiento.",
        "dbGrowing": "La base de datos está creciendo. Se recomienda cambiar a MySQL al alcanzar los 500MB.",
        "branding": "Personalización",
        "geoProfiles": "Perfiles geográficos",
        "postback": "URL de devolución",
        "settings": "Configuración",
    ...
    "postback": {
        ...
        "postbackDefaultKeyWarning": "La clave de devolución de datos es el valor por defecto público del repositorio. Se pueden enviar conversiones falsas a su tracker. Genere una nueva clave (CLI: php cli/generate_postback_key.php).",
    ...
    "clickDetails": {
        ...
        "fields": {
            ...
            "landingAt": "Landing mostrado",
            "offerAt": "Transición a la oferta",
            "timeToOffer": "Tiempo hasta la oferta",
            "timeOnLp": "Tiempo en la landing",
            "lpScroll": "Profundidad de scroll",
    ...
    "systemSettings": {
        ...
        "updateNotify": "Notificarme sobre nuevas versiones",
        "updateNotifyDesc": "Comprueba en GitHub si hay una versión más reciente al cargar el panel. Desactivado significa que la solicitud no se envía en absoluto: la comprobación es una llamada de red a GitHub y cuesta espera en servidores que no pueden alcanzarlo.",
    ...
    "users": {
        ...
        "campaignItems": "Campañas asignadas (visibles con acceso Own + Selected / Selected)",
    ...
    "botSettings": {
        ...
        "clearAll": "Borrar todo",
        "feedTitle": "Rangos de IP de centros de datos y rastreadores",
        "feedMissing": "Aún no descargados: hasta entonces el cloaking no puede usar la capa de rangos",
        "feedFresh": "Actualizados",
        "feedStale": "Con más de un día",
        "feedUpdate": "Actualizar ahora",
        "feedUpdating": "Actualizando…",
        "feedUpdateError": "No se pudieron actualizar los rangos",
        "clearSourceHint": "Eliminar solo las entradas de esta fuente",
        "addIp": "Agregar IP",
    ...
    "logs": {
        ...
        "lastRecords": "Use «Cargar más» para retroceder o exporte todo a CSV (hasta 100.000 filas, con los filtros aplicados).",
        "shownCount": "Registros mostrados: {count}.",
        "loadMore": "Cargar más",
        "exportCsv": "Exportar CSV",
        "exportHint": "Descargar el registro de esta pestaña con los filtros actuales (hasta 100.000 filas)",
        "colStream": "Flujo",
        "filterByStream": "ID de flujo",
        ...
        "colLpTime": "Tiempo en LP",
        "colIsp": "ISP",
        "colAsn": "ASN",
        "colProxyType": "Tipo de proxy",
        "routeMoney": "Dinero",
        "routeSafe": "Safe",
        "routeNone": "—",
        "filterByCampaign": "Filtrar por campaña",
        "filterByRoute": "Filtrar por ruta",
        "routeFilterAll": "Todas las rutas",
        "routeFilterMoney": "Solo dinero",
        "routeFilterSafe": "Solo safe",
        "filterByReason": "Filtrar por razón"
    },
    "campaignReports": {
    ...
    "telegram": {
        ...
        "modeWebhook": "webhook",
        "modePolling": "sondeo",
        "connectedPolling": "Telegram no puede llegar a este panel por HTTPS, así que el bot recoge sus mensajes él mismo. No hay nada más que hacer.",
        "pollingReason": "El panel no está en un dominio HTTPS, así que Telegram no puede llamarlo. En su lugar, el bot pide los mensajes a Telegram una vez por minuto.",
        "pollActive": "El sondeo está funcionando. Conecta un chat con un código abajo.",
        "pollStale": "El worker de sondeo lleva más de 5 minutos sin dar señales. Comprueba que su línea de cron existe, o ejecútalo a mano:",
        "webhookDeliveryError": "Telegram no pudo entregar una actualización a este panel:",
        "webhookUrl": "Webhook registrado en:",
        "noChats": "Todavía no hay ningún chat conectado al bot.",
        "noChatsHintWebhook": "Obtén un código abajo y envíalo al bot. Si no pasa nada, Telegram no está llegando a este panel: revisa el estado del webhook arriba.",
        "noChatsHintPolling": "Obtén un código abajo, envíalo al bot y actualiza en un minuto: el sondeo se ejecuta una vez por minuto.",
        "domainHintTitle": "Abre el panel en un dominio, no por IP",
        "domainHintBody": "Telegram solo llama al webhook de un bot por HTTPS, en un nombre de dominio con un certificado válido: no se conectará a una dirección IP ni a http sin cifrar. Ahora mismo el panel está abierto en",
        "domainHintFallback": "Apunta un dominio a este servidor, emite un certificado para él en la sección Dominios y abre el panel en https://tu-dominio/admin.php para conectar el bot desde allí. Sin dominio el bot también funciona: recoge sus mensajes él mismo, una vez por minuto.",
        "pollingSwitchToDomain": "Para pasar a webhook: abre el panel en https://tu-dominio/admin.php y vuelve a conectar el bot. Ahora está abierto en",
        "connectedChats": "Chats conectados",
        "linkTitle": "Conectar un chat",
        "linkDesc": "Solo los chats conectados con un código de un solo uso pueden usar el bot. Obtén un código y envíalo al bot desde el chat que quieras conectar (privado o grupo).",
        "linkGenerate": "Obtener código",
        "linkSend": "Envía esto al bot:",
        "linkOpenBot": "Abrir el bot",
        "linkExpires": "El código sirve una sola vez y durante 15 minutos.",
        "linkError": "No se pudo crear el código.",
        "removeChat": "Desconectar este chat",
        "removeChatConfirm": "¿Desconectar {name} del bot? Dejará de recibir notificaciones hasta que se vuelva a conectar con un código nuevo.",
        "chatRemoved": "Chat desconectado.",
    ...
    "privacy": {
        ...
        "errRedirectUrl": "La acción de redirección necesita una URL http(s) válida: indica la dirección completa a la que se enviarán esas peticiones.",
        "saveSuccess": "Configuración guardada exitosamente",
        "saveError": "error",
        "networkError": "Error de red"
    },
    ...
    "branding": {
        ...
        "terminal": "Terminal",
        "terminalDesc": "Verde fósforo sobre CRT: líneas de escaneo, viñeta y cifras tabulares",
        "aurora": "Aurora",
        "auroraDesc": "Luz fría a la deriva sobre azul marino profundo, con brillo bajo la barra",
    ...
    "update": {
        "gitUpdateComposerNote": "La línea 3 descarga un Composer fijado (2.10.3) solo si el servidor aún no tiene composer.phar; las instalaciones anteriores a v1.6.0 conservan el suyo. El botón de actualización del panel hace lo mismo automáticamente y verifica la suma de control.",
        "cachedResult": "Mostrando una comprobación en caché del",
    ...
    "cloaking": {
        ...
        "diagnosticsViewLogs": "Ver en log de clics",
        "almostAllSafeWarning": "Casi todo el tráfico se está dirigiendo a la página segura. Comprueba las razones abajo antes de seguir gastando en esta campaña.",
        ...
        "excludeSafeFromReportsHint": "Los hits de Safe Page siguen visibles en el log de clics, pero salen de Visitantes y de todo lo derivado: únicos, bots, referrers vacíos, costo y CPV. Nunca formaron parte de los Clics (un hit safe no llega a la oferta), así que Clics, CPC y CR no cambian en ningún caso."
    },
    "postbackQueue": {
    ...
    "cloakReasons": {
        "geo_country": "El país del visitante no está en la lista permitida del stream.",
        "geo_unknown": "No se pudo determinar el país: no hay base geo instalada o IP no reconocida.",
        "device_type": "El tipo de dispositivo del visitante no está en la lista permitida del stream.",
        "isp_blocklist": "El ISP del visitante coincide con la lista de bloqueo de bots/datacenter.",
        "crawler_or_tool_ua": "User-agent coincide con un crawler, bot o herramienta de depuración conocida.",
        ...
        "asn_datacenter": "ASN coincide con un datacenter o proveedor de hosting conocido.",
    ...
    "namecheap": {
        ...
        "price": "Precio",
        "priceEstimate": "Precio estimado de registro por 1 año. Namecheap determina el importe final.",
        "priceUnavailable": "Precio no disponible. Vuelve a comprobar la disponibilidad antes de comprar.",
...
,
        ...
        "oauthNotConfiguredTitle": "1-Click OAuth requiere credenciales de la app",
        "oauthNotConfiguredHint": "El botón 1-Click requiere el App ID y App Secret de TikTok for Business. Si no tienes una app de desarrollador, usa la conexión directa por token de abajo (no requiere crear app).",
        "tokenHowTo": "Guía de integración y claves de TikTok",
        "tokenHowToHint": "📌 Método 1: Conexión directa por token (Recomendado — sin crear app):\n1. Inicia sesión en TikTok for Business (ads.tiktok.com) → abre tu cuenta publicitaria.\n2. Copia el Advertiser ID (ID numérico en la barra superior).\n3. En TikTok Business Center → Apps o Events Manager, genera un Long-term Access Token con permisos Advertising Read / Reporting.\n4. Pega el Access Token y Advertiser ID abajo y pulsa «Probar conexión» → «Guardar».\n\n📌 Método 2: 1-Click OAuth (Detección automática de cuentas y píxeles):\n1. En TikTok for Business Developer Portal (business-api.tiktok.com), crea una app de desarrollador.\n2. En Authorized Redirect URI, introduce la URL exacta del tracker (requiere HTTPS):\n{redirect_uri}\n3. Introduce el App ID y App Secret abajo (o en .env como ORBITRA_TIKTOK_APP_ID y ORBITRA_TIKTOK_APP_SECRET).\n4. Tras guardar, el botón 1-Click podrá abrir la ventana de login y conectar cuentas en 1 clic.",
        "redirectUriLabel": "URI de redirección autorizado para TikTok Developer Portal:",
        "switchToManual": "Cambiar a conexión directa por token (sin app)",
        "switchTo1Click": "Cambiar a 1-Click OAuth",
        "httpsNotice": "💡 Nota: 1-Click OAuth requiere un dominio HTTPS. Si accedes por IP directa, usa la conexión directa por token."
    },
    "googleAdsCosts": {
        ...
        "oauthNotConfiguredTitle": "1-Click OAuth requiere claves de Google Cloud y MCC",
        "oauthNotConfiguredHint": "El botón 1-Click requiere Developer Token (de MCC) y OAuth Client ID + Secret (de Google Cloud Console). Si no los tienes, puedes conectarte directamente con un Refresh Token abajo.",
        "howTo": "Guía de integración y claves de Google Ads",
        "howToHint": "📌 Método 1: Conexión directa por token (Manual):\n1. Customer ID: Número de 10 dígitos en la esquina superior derecha de Google Ads (formato 123-456-7890).\n2. Developer Token: En tu cuenta Google Ads MCC → Herramientas y configuración → Centro de API (copia el token).\n3. Client ID y Client Secret: En Google Cloud Console (console.cloud.google.com) → APIs y servicios → Credenciales → Crear credenciales OAuth 2.0 (Aplicación web).\n4. Refresh Token: Token de acceso obtenido mediante OAuth Playground o asistente de autorización.\n5. Pega las claves abajo, pulsa «Probar conexión» y «Guardar».\n\n📌 Método 2: 1-Click OAuth (Detección automática de cuentas directas y MCC):\n1. En Google Cloud Console, añade esta URI de redirección autorizada exacta (requiere HTTPS):\n{redirect_uri}\n2. Guarda Developer Token, Client ID y Client Secret en el servidor (en .env o en el formulario de abajo).\n3. El botón 1-Click se activará para iniciar sesión con Google en 1 clic y seleccionar cuentas.",
        "howToStep3": "💡 Consejo: Si accedes al tracker por IP directa sin SSL, Google y TikTok bloquean los callbacks OAuth — usa la conexión directa por token (Manual).",
        "redirectUriLabel": "URI de redirección autorizado para Google Cloud Console:",
    ...
    "streamRefine": {
        ...
        "directUrlHelp": "El tráfico se redirigirá directamente a esta URL sin necesidad de crear una oferta en el tracker. Se admiten macros como {subid}, {clickid}, {country}, {ip}, {sub_id_1}..{sub_id_30}. Cada salto a este enlace cuenta como clic en los informes.",
    ...
    "leadforge": {
        ...
        "builtInNetworks": "Redes CPA",
        "myNetworks": "Mis redes de afiliados",
        "suggestAdapter": "El adaptador integrado {name} probablemente encaja mejor con esta red que un POST personalizado genérico.",
    ...
    "dimensions": {
        ...
        "deletedStream": "Flujo eliminado",
        "unnamedStream": "Flujo sin nombre",
        "country": "País",
        "region": "Región",
        "city": "Ciudad",
        "deviceType": "Tipo de dispositivo",
        ...
        "day": "Fecha (Día)",
        "hour": "Hora",
        "lpTime": "Hasta la oferta (rango)",
        "lpDwell": "Tiempo en LP (rango)",
        "pwaEntryScreen": "PWA: pantalla de entrada",
        "pwaLastScreen": "PWA: última pantalla",
        "adCampaignId": "ID de campaña publicitaria",
    ...
    mobileCards: {
        "showMore": "Más",
        "showLess": "Menos",
        "cardMetrics": "Métricas de la tarjeta",
        "cardMetricsHint": "Se muestran en cada tarjeta, en este orden",
        "moveUp": "Subir",
        "moveDown": "Bajar"
    },
    "media": {
        "title": "Galería de contenido",
        "subtitle": "Biblioteca compartida de imágenes: úsala en ofertas, landings y cualquier selector de archivos.",
        "upload": "Subir imágenes",
        "uploadHint": "Haz clic o arrastra imágenes aquí (webp, jpg, png, gif · hasta 10 MB)",
        "uploadingCount": "Subiendo ({n})…",
        "allFiles": "Todos los archivos",
        "searchPlaceholder": "Buscar por nombre de archivo…",
        "filterUser": "Usuario",
        "statusActive": "Activas",
        "statusInactive": "Inactivas (eliminadas)",
        "newFolder": "Nueva carpeta",
        "folderNamePlaceholder": "Nombre de la carpeta (hasta 50 caracteres)",
        "renameFolder": "Renombrar carpeta",
        "deleteFolder": "Eliminar carpeta",
        "deleteFolderConfirm": "¿Eliminar la carpeta «{name}»? Los archivos permanecen en la biblioteca (raíz).",
        "selected": "Seleccionadas: {n}",
        "move": "Mover",
        "moveTitle": "Mover a carpeta",
        "noFolder": "Sin carpeta (raíz)",
        "restore": "Restaurar",
        "deselectHint": "Clic para deseleccionar",
        "selectHint": "Clic para seleccionar",
        "copyUrl": "Copiar URL",
        ...
        "cropSkip": "Omitir",
        "cropHint": "Arrastra el marco, ajústalo por las esquinas: el resultado será exactamente {w}×{h}.",
        "exactSize": "Tamaño exacto",
        "croppable": "Se puede recortar a {w}×{h}",
        "tooSmall": "Demasiado pequeña para {w}×{h}",
        "replaceFromGallery": "Reemplazar desde la galería",
        "insertImage": "Insertar imagen",
        "err_extension": "Este tipo de archivo no está permitido",
        "err_not_image": "El archivo no es una imagen válida",
        "err_too_large": "Archivo demasiado grande (máx. 10 MB)",
        "err_upload": "Error al subir",
        "err_store": "No se pudo guardar el archivo",
        "err_no_files": "No se recibieron archivos",
        "err_bad_request": "Solicitud incorrecta",
        "err_folder_name": "El nombre de la carpeta debe tener de 1 a 50 caracteres",
        "err_folder_exists": "Ya existe una carpeta con ese nombre"
    },
    pwa: {
        title: "Landing PWA",
        updateAvailable: "Actualización disponible",
        reload: "Recargar",
        loadFailed: "No se pudo cargar la configuración del PWA",
        nameRequired: "El nombre interno y el nombre de la app son obligatorios",
        saveFailed: "Error al guardar el PWA",
        saving: "Guardando y generando estáticos…",
        openPreview: "Abrir vista previa",
        copyLink: "Copiar enlace",
        linkServerAddress: "dirección del servidor: vincula un dominio para anuncios",
        stepGeneral: "General",
        stepReviews: "Reseñas",
        preview: "Vista previa",
        presets: "Plantillas",
        presetsHint: "Una plantilla rellena el diseño y el contenido de ejemplo; tus nombres se mantienen",
        dragHint: "Arrastra las reseñas por el asa para reordenarlas",
        funnelTitle: "Embudo de visita (pantallas)",
        funnelHint: "Pantallas de la visita en orden. El primer paso activado es lo que el visitante ve primero; el CTA de un paso lleva al siguiente, y el último ejecuta la instalación. Las vistas de cada pantalla se registran automáticamente.",
        funnelFirstBadge: "Primera pantalla",
        funnelOff: "no",
        funnelEdit: "Editar pantalla",
        funnelMoveUp: "Subir",
        funnelMoveDown: "Bajar",
        funnelEnabledTitle: "Participa en el embudo",
        funnelAddScreen: "Añadir pantalla",
        funnelStepJs: "Script de seguimiento de la pantalla (JS)",
        funnelStepJsHint: "Se ejecuta en la PRIMERA visualización: los píxeles publicitarios solo se activan si el visitante llegó a esta pantalla. Las vistas se registran automáticamente.",
        funnelStepStore: "Ficha de la tienda",
        funnelStepInstructions: "Instrucciones de instalación",
        funnelStepPush: "Tarjeta de notificaciones",
        funnelStepScreen: "Pantalla personalizada",
        funnelCardTitle: "Embudo por pantallas",
        funnelCardLoadFailed: "No se pudo cargar la estadística del embudo",
        funnelCardClicks: "Visitas",
        funnelCardWithScreens: "Vieron pantallas",
        funnelCardIntents: "Intenciones de instalar",
        funnelCardInstalls: "Instalaciones",
        funnelCardOfferClicks: "Clics a la oferta",
        funnelCardPushSubs: "Suscripciones push",
        funnelCardNoData: "Aún no hay vistas de pantallas. Configura el embudo en el editor y envía tráfico.",
        funnelCardScreens: "Pantallas",
        funnelCardScreen: "Pantalla",
        funnelCardViews: "Vistas",
        funnelCardUniq: "Únicos",
        funnelCardEntry: "Entrada",
        funnelCardExits: "Salidas",
        funnelCardTransitions: "Transiciones",
        back: "Atrás",
        next: "Siguiente",
        sectionBasic: "Básico",
        internalName: "Nombre interno",
        internalNameHint: "Para identificarlo en el panel; los visitantes nunca lo ven",
        state: "Estado",
        appName: "Nombre de la app",
        developer: "Desarrollador",
        category: "Categoría",
        language: "Idioma del PWA",
        languageHint: "Cualquier código — pt, pt-BR, ar… Los idiomas desconocidos usan inglés en los textos integrados (instrucciones, avisos)",
        pushEnabled: "Notificaciones push",
        pushEnabledHint: "Tras la instalación, la app ofrece notificaciones una vez — los suscriptores son un canal gratuito de re-enganche que suele mejorar la conversión. Requiere claves de la página Base push.",
        buttonText: "Texto del botón",
        downloads: "Descargas",
        adsLabel: "Etiqueta de anuncios",
        version: "Versión",
        sectionMedia: "Icono y capturas",
        appAction: "Comportamiento de la app (instalada)",
        appActionHint: "Qué ve el visitante al abrir la app instalada desde la pantalla de inicio — el paso de dinero del embudo",
        appActionStore: "Mostrar la tienda",
        appActionOffer: "Redirigir a la oferta",
        appActionCampaign: "Redirigir a la campaña",
        appActionCampaignHint: "El visitante entra en la campaña seleccionada a través del rastreador: sus flujos y su rotación distribuyen el tráfico; {subid} mantiene la atribución de conversiones",
        appActionScreen: "Pantalla personalizada de la app",
        appScreenTitle: "Título de la pantalla",
        appScreenText: "Texto de la pantalla",
        appScreenButton: "Texto del botón",
        ...
        heroImage: "Imagen de fondo de la pantalla",        pickHero: "Elegir imagen de fondo de la galería",
        ...
        screensHint: "Hasta 10 (PNG/JPEG/WebP)",
        addScreens: "Añadir capturas",
        sectionContent: "Contenido",
        description: "Descripción",
        descriptionHint: "Macros: {value} — nombre de la app, {value1}/{value2} — desarrollador",
        tags: "Etiquetas",
        tagsHint: "Palabras clave separadas por comas bajo la descripción",
        rating: "Distribución de valoraciones",
        ratingAvg: "media",
        sectionComments: "Reseñas",
        commentName: "Nombre",
        commentDate: "Fecha",
        commentText: "Texto de la reseña",
        commentReply: "Respuesta del desarrollador",
        addComment: "Añadir reseña",
        sectionDesign: "Apariencia",
        storeStyle: "Estilo de tienda",
        storeStyleAuto: "Automático (iOS → App Store, Android → Google Play)",
        ...
        showHeader: "Cabecera con buscador",
        bottomMenu: "Menú inferior",
        showShare: "Botones de compartir",
        sectionFunnel: "Embudo y redirecciones",
        stepFlow: "Pantallas",
        stepStore: "Tienda",
        funnelAllOffHint: "Todos los pasos están desactivados: el visitante verá la ficha de la tienda. Activa un paso o añade tu propia pantalla.",
        buttonTextFlowHint: "Se usa como etiqueta del botón en el paso de instrucciones",
        iosFlow: "Flujo iOS",
        iosFlowHint: "iOS no tiene aviso nativo de instalación — muestra la instrucción «Añadir a inicio»",
        iosFlowDefault: "Predeterminado",
        iosFlowInstruction: "Instrucción",
        autoRedirect: "Redirección automática tras abrir",
        declineRedirect: "Redirección al rechazar la instalación",
        installRedirect: "Redirección tras instalar",
        installRedirectHint: "0 = inmediatamente después del evento de instalación",
        timerOff: "Apagado",
        timerImmediate: "Inmediatamente",
        supportEnabled: "Bloque de soporte",
        supportEmail: "Email de soporte",
        supportAddress: "Dirección de soporte",
        whatsNew: "Bloque «Novedades»",
        whatsNewText: "Texto de novedades",
        previewStore: "Tienda",
        previewApp: "Pantalla de la app",
        actionTarget: "Acción de destino / Redirección",
        actionTargetHint: "A dónde se redirige al usuario al pulsar el botón, en autorredirección o al abrir la app instalada",
        targetOffer: "Redirigir a oferta (flujo)",
        targetCampaign: "Redirigir a campaña",
        targetUrl: "URL directa",
        targetNotFound: "404 Not Found",
        targetCampaignLabel: "Campaña de destino",
        targetCampaignPlaceholder: "-- Seleccionar campaña --",
        targetUrlLabel: "URL de destino",
        targetUrlPlaceholder: "https://example.com/?subid={subid}",
        targetNotFoundHint: "El usuario verá una página de error 404",
        appScreenType: "Diseño de la pantalla de app",
        appScreenTypeHint: "Elige entre un panel nativo, minijuegos interactivos integrados o tu propio código HTML5/JS (tragamonedas, ruleta, quiz)",
        screenTypeLobby: "Lobby de la app (Panel)",
        screenTypeSlot: "Juego de tragamonedas 777 interactivo",
        screenTypeWheel: "Ruleta de bonos de la suerte",
        screenTypeCustom: "Código HTML & JavaScript personalizado",
        customHtmlLabel: "Código HTML personalizado",
        customHtmlPlaceholder: "<div id=\"game-container\">...</div>",
        customJsLabel: "Código JavaScript personalizado",
        customJsPlaceholder: "// Llama a window.orbitraRedirect() al ganar:\nfunction onGameWin() {\n  window.orbitraRedirect();\n}",
        customJsTip: "Llama a window.orbitraRedirect() o agrega class=\"install-trigger\" para iniciar la redirección hacia la oferta/campaña.",
        insertSlotBoilerplate: "Insertar plantilla de tragamonedas",
        insertWheelBoilerplate: "Insertar plantilla de ruleta",
        sectionCustomScripts: "Scripts, estilos CSS y píxeles",
        customCssLabel: "Estilos CSS y animaciones personalizadas",
        customCssHint: "Anula colores, degradados o define animaciones personalizadas con CSS @keyframes",
        customCssPlaceholder: "/* CSS personalizado y animaciones keyframe */\n.install-btn { transform: scale(1.02); }",
        customHeadLabel: "Código para <head> / Píxeles de seguimiento",
        customHeadPlaceholder: "<!-- Píxeles de FB, TikTok, Google Tag Manager, fuentes -->",
        customJsGlobalLabel: "JavaScript global",
        customJsGlobalPlaceholder: "// JS personalizado ejecutado antes de </body>",
        animationGlow: "Brillo de botón y efecto de neón (Impulsor de CTR)",
        showLiveBadge: "Contador de jugadores en vivo (Prueba social)",
        soundEnabled: "Efectos de sonido de casino / juegos",
        vibrationEnabled: "Respuesta de vibración háptica",
        domainLabel: "Dominio",
        ...
        offerLabel: "Oferta",
        offerNone: "— Sin seleccionar —",
        offerSaving: "Guardando la oferta…",
        offerError: "No se pudo guardar la vinculación de la oferta",
    },
    push: {
        navLabel: "Base push",
        noAccess: "Sin acceso",
...
vapidHint: "Se generan una vez y se conectan automáticamente — cada PWA recibe la clave pública al servir su página. No hay que pegarla en ningún sitio.",
        ...
        endpoint: "Endpoint",
        status: "Estado",
        empty: "Aún no hay suscriptores — instala la PWA y acepta las notificaciones",
        statusLive: "Vivo",
        statusDead: "Muerto",
        delete: "Eliminar",
        deleteConfirm: "¿Eliminar este suscriptor permanentemente?",
        prev: "Anterior",
        next: "Siguiente",
        loadFailed: "No se pudo cargar la base push",
        tabSubscribers: "Suscriptores",
        tabMessages: "Mensajes",
        newMessage: "Nuevo mensaje",
        editMessage: "Editar mensaje",
        messagesEmpty: "Aún no hay mensajes — crea uno y pulsa Enviar",
        messageTitle: "Título",
        messageTitlePlaceholder: "Tu donación se duplica hoy",
        messageText: "Texto",
        messageTextPlaceholder: "Texto de la notificación, hasta 400 caracteres",
        iconUrl: "URL del icono (opcional)",
        linkUrl: "Enlace",
        linkHint: "Pega el enlace de una campaña del tracker — {subid} se sustituye por el click_id del suscriptor, las conversiones se atribuyen con los postbacks normales",
        segment: "Segmento",
        segmentAll: "Todos los suscriptores",
        segmentReg0: "Sin registros",
        segmentReg1Dep0: "Registrados, sin depósitos",
        segmentReg1Dep1: "Registrados con depósitos",
        kind: "Tipo",
        kindManual: "Manual",
        kindEvent: "Por evento",
        event: "Evento",
        eventInstall: "Instalación",
        eventLead: "Lead",
        eventSale: "Venta",
        delay: "Retraso, segundos",
        delayUnit: "s",
        delayHint: "El push se envía estos segundos después del evento",
        sent: "Enviados",
        failed: "Errores",
        queued: "En cola",
        workerStalled: "Hay mensajes en cola pero el worker de entrega no se está ejecutando: no se enviará nada. Añade esta línea al crontab de www-data:",
        contactLabel: "Contacto del remitente (VAPID sub)",
        contactHint: "mailto: o https: — la dirección donde los servicios de push pueden contactarte. Apple rechaza el marcador de posición incluido y responde 403, así que pon uno real antes de enviar a iPhones.",
        contactInvalid: "El contacto debe empezar por mailto: o https:",
        lastFailCode: "Último error",
        failCodeNoReply: "sin respuesta",
        sendNow: "Enviar ahora",
        confirmSend: "¿Poner el mensaje en cola para todos los suscriptores activos que coincidan?",
        sendQueued: "En cola:",
        messageDeleteConfirm: "¿Eliminar este mensaje? La cola y el registro de envíos se conservan.",
        keysExist: "Las claves ya existen — confirma el reemplazo para rotarlas",
        titleTextRequired: "Se requieren título y texto",
